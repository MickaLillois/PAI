...
include("../Connexion/connexion.php");
  ...
  `TEMPSREPONSEMOYEN`=((SELECT (TEMPSREPONSEMOYEN*NBPARTIESSTANDARDJOUEES) FROM STATSUTILISATEUR WHERE MAILUTILISATEUR = :user)+ :tempsResponseMoyen )/((SELECT NBPARTIESSTANDARDJOUEES FROM STATSUTILISATEUR WHERE MAILUTILISATEUR = :user)+1),
